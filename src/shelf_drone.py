...
if __name__ == "__main__":
    ...
    prop2 = ShelfPropeller("T-Motor NS 24x72")
    ...
    drone2 = Drone(propeller=prop2, motor=motor, esc=esc, tank_mass=1.65, mh2=0.12)
    ...
    print(drone2.compute_endurance(1, mh2=0.12))
